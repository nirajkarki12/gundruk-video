...
<html lang="en">
    <head>
        ...
        <link href="{{asset('vendor/adult/css/bootstrap.min.css')}}" rel="stylesheet">
        <link rel="stylesheet" href="{{asset('vendor/adult/css/jquery-ui.css')}}">
        <link href="{{asset('vendor/adult/css/style.css')}}" rel="stylesheet">
    ...
    <body>
        ...
        <script src="{{asset('vendor/adult/js/jquery.min.js')}}"></script>
        <script src="{{asset('vendor/adult/js/bootstrap.min.js')}}"></script>
        <script src="{{asset('assets/bootstrap/js/jquery-ui.js')}}"></script>
        <script src="{{asset('vendor/adult/js/scripts.js')}}"></script>
