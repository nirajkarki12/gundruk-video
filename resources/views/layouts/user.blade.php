...
<head>
    ...
    <link rel="stylesheet" href="{{asset('vendor/streamtube/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/bootstrap/css/jquery-ui.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/streamtube/fonts/font-awesome/css/font-awesome.min.css')}}">
    <link href='https://fonts.googleapis.com/css?family=Roboto:400,700' rel='stylesheet' type='text/css'> 
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/streamtube/css/slick.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/streamtube/css/slick-theme.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/streamtube/css/style.css')}}">

    <link rel="stylesheet" type="text/css" href="{{asset('vendor/streamtube/css/responsive.css')}}">
...
<body>
    ...
    <script src="{{asset('vendor/streamtube/js/jquery.min.js')}}"></script>
    <script src="{{asset('vendor/streamtube/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('assets/bootstrap/js/jquery-ui.js')}}"></script>
    <script type="text/javascript" src="{{asset('vendor/streamtube/js/jquery-migrate-1.2.1.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('vendor/streamtube/js/slick.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('vendor/streamtube/js/script.js')}}"></script>
